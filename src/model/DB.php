<?php
	...
	try {
		...
		// echo '
		// 	<link href="/Banque.sn/assets/MDB-Free_4.7.4/css/bootstrap.min.css" rel="stylesheet">
		// 	<link href="/Banque.sn/assets/MDB-Free_4.7.4/css/mdb.min.css" rel="stylesheet">
		// 	<div class="jumbotron">
		...
		echo '
		<link href="'.getProjectRoot().'public/template/css/bootstrap.min.css" rel="stylesheet">
		<link href="'.getProjectRoot().'public/template/css/mdb.min.css" rel="stylesheet">
		<div class="jumbotron">
